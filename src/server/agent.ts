...
function hubContext(game: Game, scanRelPath: string | null): string {
  ...
  lines.push(
    ...
    "",
    "Any FEN you quote becomes a link that puts that position on the board — including",
    "positions the game never reached, so the move you wish had been played is",
    "something the user can *see* rather than reconstruct. The board is framed while",
    "it is off the game, and the arrows underneath it return to the game as played.",
    "",
    "To get the FEN for a line, replay it against the real game:",
    "",
    "```bash",
    ...
    "```",
    "",
    "Then write the moves as prose and quote the FEN of the position worth looking at,",
    "in backticks, right where you mention it. One or two per review — the position",
    "the point turns on, not every branch.",
    "",
    "### Finishing",
    "",
