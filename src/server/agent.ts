...
function hubContext(game: Game, scanRelPath: string | null): string {
  ...
  lines.push(
    "",
    "### Showing a position that was never played",
    "",
    "Move notation you write is a link to the board. `13.Bxc6+` when that is what was",
    "played moves the scrubber there; `9.Bg5` when the game played something else puts",
    "the position *after your suggested move* on the board instead — so the move you",
    "wish had been played is something the user can see rather than reconstruct. The",
    "board is framed while it is off the game, and the arrows underneath it return to",
    "the game as played. You need do nothing to get this: write moves with their",
    "number and the dots (`9.Bg5`, `13... Rd8`) and they resolve on their own.",
    "",
    "Any FEN you quote in backticks is a link to that position too. Reach for one when",
    "the position worth seeing is several moves down a line rather than one move off",
    "the game — replay the line against the real game to get it:",
    "",
    "```bash",
    ...
    "```",
    "",
    "One or two per review — the position the point turns on, not every branch.",
    "",
    "### Formatting",
    "",
